...
import com.ws.skelton.todolist_.MainActivity;
...
//
    ...
    public int getNotibarIcon1() { return R.drawable.ic_todo; }
    public int getNotibarString1() { return R.string.todo_text1; }
    public void callNotibar1(Activity activity, String nt) {
        try{
            Intent todoIntent = new Intent(activity.getApplicationContext(), MainActivity.class);
            activity.startActivity(todoIntent);
            activity.finish();
        }catch (Exception e){
...
//
//    public int getNotibarIcon2() { return R.drawable.notibar_icon_1; }
//    public int getNotibarString2() { return R.string.todo_text2; }
