package com.ws.skelton.todolist_.adapter;
...
import com.ws.skelton.todolist_.vo.Note;
        ...
        public ViewHolder(View itemView){
            ...
            deleteButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    deleteToDo(TODO);
                    Toast.makeText(v.getContext(),"삭제되었습니다. 드래그해서 새로고침하세요!",Toast.LENGTH_SHORT).show();
                }
